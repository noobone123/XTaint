...
class MAYALIAS(dataflow.SimProcedure):
    """
    MAYALIAS(p1, p2): pointer p1 and p2 are may alias.
    """

    def run(self, arg1, arg2):
        print("execute MAYALIAS %x" % (self.block.addr))
        self.check_alias(arg1, arg2, 'may')
        return 1
