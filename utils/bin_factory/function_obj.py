...
class FunctionObj(object):
    """
    The function object of a binary.
    """
    def __init__(self, addr, 
        ...
        self.forward_execute_label = True
    ...
    def __eq__(self, other):
        if isinstance(other, FunctionObj):
    ...
    def get_taint_exprs(self, caller_function, callsite_taints):
        ...
        for taint_expr in self.taint_exprs:
            ...
            if self.is_add_taint(taint_expr, taint_results) and taint_id in context_ids:
                ...
                new_expr.expr.taint_sources = input_expr.expr.taint_sources
